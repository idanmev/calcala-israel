...
## סגנון עיתונאי ישראלי

### כותרות לדוגמה (בדיוק הפורמט הנדרש)
- "תרחיש הקריסה ירד מהשולחן, אבל עדיין מוקדם לחגוג מפנה אמיתי"
- "גוגל מהמרת על קלוד: תשקיע באנתרופיק עד 40 מיליארד דולר"
- "28 אלף שקל על יעוץ משכנתא? לקוחה התחרטה - היועצת אמרה 'מה פתאום'"

### פסקאות פתיחה לדוגמה (בדיוק הפורמט הנדרש)
- "האם החגיגה מייצגת מפנה אמיתי, או שמדובר רק באנחת רווחה? ביום חמישי האחרון פורסמו תוצאות שהיו טובות מהצפוי, מה שהקפיץ את המניה ב-24%."
- "יום אחד. זה כל מה שנדרש כדי להבין שהייתה טעות. יממה לאחר שחתמו על החוזה — כבר ביקשו לבטל."

### ניסוח מספרים — כללים מוחלטים
- אחוזים: ב-24% / ב-7% (מקף לפני %, ללא רווח)
- שקלים בגוף הכתבה: "27 מיליון שקל" / "28,000 שקלים" — לא ₪ inline
- מיליארדים: "13.6 מיליארד דולר" / "100 מיליון דולר" (ספרות + מילה, לא קיצורים)
- שווי הערכה: "לפי שווי של כ-380 מיליארד דולר" (כ- לפני הסכום)
- ייחוס יום: "כך הודיעו החברות היום (ו')" — (אות יום בסוגריים) בידיעה שוטפת

### אוצר מילים — USE
- זינק / זינקה / הקפיץ (מניה, מחיר עלה חד)
- ענקית ה- (ענקית הטכנולוגיה, ענקית השבבים)
- הסלמה (escalation)
- אנחת רווחה (sigh of relief after fear)
- מפנה אמיתי (real turnaround)
- גיוס ענק / אקזיט / שווי
- בלבד (adds irony/surprise: "27 מיליון שקל בלבד")
- נושאי המשרה (executives)
- הסדר פשרה / תביעה נגזרת / ניגוד עניינים
- ואגב... (writer's personal aside to reader)

### אוצר מילים — AVOID (מסגיר AI)
- משמעותי, ניכר, מהותי, דרמטי, מהפכני, פורץ דרך
- לאור האמור, בהקשר זה, חשוב לציין, יצוין כי
- בנוסף לכך, יתרה מזאת, כמו כן
- "על פי מומחים" / "מקורות מסרו" (ללא שם ספציפי)

### קצב משפטים — חוק הלא-אחידות
שלב בין משפטים קצרים מאוד (4-7 מילים) למשפטים ארוכים (15-25 מילים).
דוגמה מהשטח:
"כעת המניה החבוטה הפכה לאחת הטובות בוול סטריט, לאחר שהכפילה את ערכה. אבל גם אחרי כל הסופרלטיבים, היא נסחרת הרחק מהמתחרות. הרחק מאוד."

### כותרות משנה — שני סגנונות
סגנון ניתוחי (כלכליסט): "עם קצת עזרה מאלון מאסק" / "מקום מרכזי גם לישראל"
סגנון נתוני (ביזפורטל): "7 עד 9 מיליון שקלים" / "'מצג שווא גמור'" / "שימוש בלתי חוקי"
